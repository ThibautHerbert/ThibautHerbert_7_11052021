      ...
      <div class="row">
        <div class="mx-3 text-start d-flex flex-wrap"  >
          ...
          <button class="btn btn-outline-secondary border rounded-pill m-1" @click="likePost">
              ...
              Bravo</button>
          <button class="btn btn-outline-light text-dark border rounded-pill m-1" @click="likePost">
          ...
          <div class="flex-row justify-content-end">
            <button class="btn btn-outline-primary border rounded align-self-center m-1" @click="writeComment">
